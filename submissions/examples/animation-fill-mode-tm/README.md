...
Demonstrates animation-fill-mode utilities (none forwards backwards both) using easemotion tokens. This submission demonstrates how to leverage the EaseMotion CSS design token system (--ease-* variables) for consistent styling across your project.
